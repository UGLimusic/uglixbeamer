...
% 
%
% commandes indépendantes des librairies, ou dépendantes de librairies communes à toutes les options
%
...
\newcommand\premiereS{1$^{\textrm{ère}}$ S}                                           % 1S
\newcommand\premiereSTMG{1$^{\textrm{ère}}$ STMG}                                     % 1STMG
\newcommand\terminaleES{T$^{\textrm{ale}}$ ES}                                        % TES
