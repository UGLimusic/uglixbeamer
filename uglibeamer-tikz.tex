...
%Switch de style
\def\nouveaustyle{\renewcommand{\exo}{\exoN}\renewcommand{\titre}{\titreN}\renewcommand{\partie}{\section*}}
%
...
\newcommand{\titre}[3]
	{
	\begin{tikzpicture}
		\shade [left  color = gray!50!white,right color = white, shading angle = 75]
					(0,0) -- (\columnwidth,0) -- (\columnwidth,3em) -- (0,3em) -- cycle ;
		\draw (0.5em,1.5em) node[right]{\titlefont #2};
		\draw (\columnwidth-0.5em,1.5em) node[left]{\titlefont #3};
		\draw (\columnwidth*0.5,1.5em) node{\titlefont\LARGE #1};
	\end{tikzpicture}
	}
...
\newcommand{\titreN}[3]
	...
	\begin{tikzpicture}
		...
		\draw (0,0) 					node[right]	{\titlefont\color{bleufonce@color} #2};
		\draw (\columnwidth,0) 	node[left]	{\titlefont\color{bleufonce@color} #3};
		\draw (\columnwidth*0.5,0) 		node		{\titlefont\Huge\color{bleufonce@color}  #1};
	\end{tikzpicture}
	}

%_____________________________________________________________________________________________________________________________________________________________________________
%
\newcommand{\titreinterro}[3]
	{
	\begin{tikzpicture}
		\shade [left  color = gray!50!white,right color = white, shading angle = 75]
					(0,0) -- (\columnwidth,0) -- (\columnwidth,7em) -- (0,7em) -- cycle ;
		\draw (0.5em,5.5em) node[right]{\titlefont Nom, Prénom :};
		\draw (0.5em,3.5em) node[right]{\titlefont #2};
		\draw (0.5em,1.5em) node[right]{\titlefont #3};
		\draw (\columnwidth*0.5,3.5em) node{\LARGE\titlefont #1};
		\draw[drop shadow,fill = white] (\columnwidth - 1em,-.5em) rectangle ++(-8em,8em);
	\end{tikzpicture}
	}
%_____________________________________________________________________________________________________________________________________________________________________________
%
...
\newcommand{\exo}[1]
	...
	\begin{tikzpicture}
		\shade [left  color = gray!50!white,right color = white, shading angle = 75]
					(0,0) -- (\columnwidth,0) -- (\columnwidth,2em) -- (0,2em) -- cycle ;
		\draw (.5em,1em)  node[right]{\titlefont\Large Exercice\ \theexoNum\ \normalsize{#1}};
...
\newcommand{\exoN}[1]
	{
	\addtocounter{exoNum}{1}
	{\titlefont\color{bleufonce@color}\Large Exercice\ \theexoNum\ \normalsize{#1}}\smallskip
	}
...
\newcommand{\exonote}[1]
	...
	\begin{tikzpicture}
		\shade [left  color = gray!50!white,right color = white, shading angle = 75]
					(0,0) -- (\columnwidth,0) -- (\columnwidth,2em) -- (0,2em) -- cycle ;
		\draw (.5em,1em)  node[right]{\titlefont\Large Exercice\ \theexoNum\ \normalsize{#1}};
		\draw[drop shadow,fill = white] (\columnwidth - 4em,-.5em) rectangle (\columnwidth - 1em,2.5em);
	\end{tikzpicture}
	}
%_____________________________________________________________________________________________________________________________________________________________________________
%
\newcommand{\partie}[1]
	...
	\begin{tikzpicture}
		\shade [left  color = gray!50!white,right color = white, shading angle = 75]
					(0,0) -- (\columnwidth,0) -- (\columnwidth,3em) -- (0,3em) -- cycle ;
		\draw (.5em,1.5em)  node[right]{\titlefont\Large #1};
	\end{tikzpicture}
	}
%_____________________________________________________________________________________________________________________________________________________________________________
%
